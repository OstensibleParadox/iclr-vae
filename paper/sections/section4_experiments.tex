...
% Figure 1: spectrum; bounded/log/power T2; objective and probe-variance collapse.
% Replace point estimates with final multi-seed confidence intervals.
...
its spectral-radius domain. We freeze
...
drift. Raw $\Ttwo$ under the correct discretization inner product is the
